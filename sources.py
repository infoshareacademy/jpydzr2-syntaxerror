...
class ProcessingData:
    ...
    def refresh_world_data(self):
        world_covid_data = pd.read_csv('https://covid.ourworldindata.org/data/owid-covid-data.csv', sep=',').to_csv('world_covid_data.csv', sep=',')
    ...
    def refresh_polish_data(self):
        polish_covid_data = pd.read_csv('https://www.arcgis.com/sharing/rest/content/items/153a138859bb4c418156642b5b74925b/data', sep=';', encoding='latin1').to_csv('polish_covid_data.csv', sep=';', encoding='utf-8')
